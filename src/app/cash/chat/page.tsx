...
const CashChatPage = () => {
    ...
    const { isLoading: isLoadingChannel } = useQuery({
        queryKey: ['agencyChannel'],
        queryFn: async () => {
            console.log("📥 [CashChatPage] Récupération du canal d'agence...");
            const response = await api.get('/staff/chat/agency-channel');
    ...
    const { data: agents = [], isLoading: isLoadingAgents } = useQuery<Agent[]>({
        ...
        queryFn: async () => {
            ...
            const response = await api.get('/staff/chat/agents');
    ...
    return (
        <div className="bg-gray-50 flex items-center justify-center">
            <div className="w-full h-[750px] flex rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white">
